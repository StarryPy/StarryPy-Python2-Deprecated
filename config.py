...
class ConfigurationManager(object):
    ...
    def __init__(self, config_subpath="config/config.json"):
        default_config_path = path.preauthChild(config_subpath+".default")
        self.config_path = path.preauthChild(config_subpath)
